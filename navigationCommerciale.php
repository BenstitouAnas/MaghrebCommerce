<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            <li class="nav-header">
                <div class="dropdown profile-element"> <span>
                    ...
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                        <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold">BENSTITOU Anas</strong>
                             </span> <span class="text-muted text-xs block">Commerciale <b class="caret"></b></span>                        </span>
                    </a>
            ...
            <li>
                <a href="commerciale_index.php"><i class="fa fa-th-large"></i> <span class="nav-label">Tableau de Bord</span></a>
            </li>
