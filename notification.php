<nav class="navbar navbar-static-top  " role="navigation" style="margin-bottom: 0">
	...
	<ul class="nav navbar-top-links navbar-right">
		<li>
			<span class="m-r-sm text-muted welcome-message">Bienvenue Anas BENSTITOU</span>
		</li>
		<li class="dropdown">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu dropdown-alerts">
				...
				<li>
					<a href="profile.html">
						<div>
							<i class="fa fa-ticket fa-fw"></i> 3 Nouvelles Tickets
							<span class="pull-right text-muted small">12 minutes</span>
						</div>
					</a>
				</li>
				<li class="divider"></li>
				<li>
					<a href="grid_options.html">
						<div>
							<i class="fa fa-usd fa-fw"></i> 9 Produits Vendus
							<span class="pull-right text-muted small">4 minutes</span>
						</div>
					</a>
				</li>
