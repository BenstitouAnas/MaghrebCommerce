   ...
   <nav class="navbar-default navbar-static-side" role="navigation">
		...
		?>
            <ul class="nav metismenu" id="side-menu">
                    ...
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo $_SESSION['nomUser']." ".$_SESSION['prenomUser']; ?></strong>
                             </span> <span class="text-muted text-xs block">Prestataire <b class="caret"></b></span> </span> </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="#">Profile</a></li>
                            <li><a href="BoiteReception.php">Tickets</a></li>
                            <li class="divider"></li>
                ...
                <li>
                    <a href="mailbox.html"><i class="glyphicon glyphicon-info-sign"></i> <span class="nav-label">Tickets </span><?php echo $msag; ?></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="BoiteReception.php">Demande Tickets</a></li>
                        <li><a href="BoiteEnvoie.php">Historique</a></li>
                    </ul>
                </li>
				
				<li>
                    <a href="demande.php"><i class="fa fa-file-text-o"></i> <span class="nav-label">Mes Clients</span></a>
                </li>
                
                <li>
                    <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">Solde</span>  <span class="pull-right label label-primary">SPECIAL</span></a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="ajouterMaterielle.php">Demande Retrait</a></li>
                        <li><a href="listeMaterielle.php">Historique</a></li>
                    </ul>
                </li>

                <li>
                    <a href="demande.php"><i class="fa fa-file-text-o"></i> <span class="nav-label">Commandes</span></a>
                </li>
				
				<li>
                    <a href="ajouterFournisseur.php"><i class="fa fa-bus"></i> <span class="nav-label">Produits</span></a>
                </li>

                <li>
                    <a href="#"><i class="fa fa-desktop"></i> <span class="nav-label">Utilisateurs</span</a>
                    <ul class="nav nav-second-level collapse">
                        <li><a href="ajouterMaterielle.php">Gestion des roles</a></li>
                        <li><a href="listeMaterielle.php"><Liste>       </Liste> utilisateurs</a></li>
                    </ul>
                </li>
            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element"> <span>
                        ...
                        <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                            <span class="clear"> <span class="block m-t-xs"> <strong class="font-bold"><?php echo $_SESSION['prenomUser']; ?></strong>
                             </span> <span class="text-muted text-xs block">Prestataire <b class="caret"></b></span> </span> </a>
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="#">Profile</a></li>
                            <li><a href="BoiteReception.php">Tickets</a></li>
