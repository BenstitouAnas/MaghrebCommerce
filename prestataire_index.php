...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            <div class="col-sm-4">
                <h2>Prestataire - Tableau de bord</h2>
                <ol class="breadcrumb">
                    <li>
                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq1" class="faq-question">What It a long
                                            established fact that a reader ?</a>
                                        <small>Par <strong>Alex Smith</strong> <i class="fa fa-clock-o"></i> Aujourd'hui
                                            2:40 pm - 24.06.2014
                                        </small>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq2" class="faq-question">Many desktop
                                            publishing packages ?</a>
                                        <small>Par <strong>Mark Nowak</strong> <i class="fa fa-clock-o"></i> Aujourd'hui
                                            3:30 pm - 11.06.2014
                                        </small>
                                    </div>
                                    <div class="col-md-3">
                            ...
                            <div class="faq-item">
                                <div class="row">
                                    <div class="col-md-7">
                                        <a data-toggle="collapse" href="#faq3" class="faq-question">Ipsum generators on
                                            the Internet tend ?</a>
                                        <small>Par <strong>Monica Rother</strong> <i class="fa fa-clock-o"></i> Vendredi
                                            7:60 pm - 12.06.2014
                                        </small>
                                    </div>
                                    <div class="col-md-3">
